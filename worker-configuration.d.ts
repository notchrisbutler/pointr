/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7118994fe17967761c6adef90883f24c)
// Runtime types generated with workerd@1.20260305.0 2026-04-21 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PokerSessionSqlite";
	}
	interface Env {
		RATE_LIMITER_CREATE: RateLimit;
		RATE_LIMITER_WS: RateLimit;
		RATE_LIMITER_INFO: RateLimit;
		POKER_SESSION: DurableObjectNamespace<import("./src/index").PokerSessionSqlite>;
	}
}
